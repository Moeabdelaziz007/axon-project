  ...
  return (
    ...
    >
      <span className="relative inline-flex h-5 w-5 items-center justify-center">
        ...
        <svg id="icon-moon" className={`absolute h-5 w-5 text-info transition-all duration-500 ease-out ${theme === 'dark' ? 'scale-100 rotate-0' : 'scale-0 rotate-180'}`} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M21 12.79A9 9 0 1111.21 3a7 7 0 109.79 9.79z"/></svg>
      </span>
